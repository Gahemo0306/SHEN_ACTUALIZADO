...
//    void on_DCDTM_clicked();
    ...
    void on_OK_clicked();
    void Info_Uniforme_Estatico(bool UPT, bool UAP, bool UCP, bool UHCC,
                                bool UCCC, bool UCC, bool UCCA, bool UGCC, double Min,
                                double Max, double Inc, bool estatico, bool incremento);
private:
    Ui::AnalisisPersonalizado *ui;
    double Max,Min,Inc;
    bool estatico,incremento;
    int VENTANAMADRE;
};
